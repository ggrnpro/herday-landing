...
import type { AffirmationPayload, RateLimitInfo } from "./lib/types";
...
export function Tool() {
  ...
  const [answers, setAnswers] = useState<AffirmationAnswers | null>(null);
  const [payload, setPayload] = useState<AffirmationPayload | null>(null);
  ...
  async function handleComposeDone(submitted: AffirmationAnswers) {
    ...
    try {
      ...
      setPayload(data.payload as AffirmationPayload);
      ...
      <section className="relative min-h-[60vh] flex items-center">
        <div className="container-narrow text-center">
          ...
          <h2 className="font-display text-[clamp(34px,5vw,52px)] leading-[1.1] tracking-[-0.02em] text-ink max-w-[20ch] mx-auto">
            You&rsquo;ve had your morning portion.
          </h2>
          <p className="mt-6 text-[17px] leading-[1.6] text-ink-soft max-w-[44ch] mx-auto">
            Want a set like this — read in your own voice, every single morning,
