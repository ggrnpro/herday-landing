          ...
          {tools.map((t, i) => (
            <Reveal key={t.slug} delay={0.06 * i}>
              ...
              >
                ...
                <h3 className="font-display text-[22px] leading-[1.15] text-ink group-hover:text-merlot transition-colors">
                  {t.title}
                </h3>
                <p className="mt-3 text-[14.5px] text-ink-soft leading-[1.55]">{t.body}</p>
                <p className="mt-7 text-[13px] text-merlot font-medium inline-flex items-center gap-1.5">
                  Open
